...
const TooltipContent = React.forwardRef<React.ElementRef<typeof TooltipPrimitive.Content>, React.ComponentPropsWithoutRef<typeof TooltipPrimitive.Content> & {side?: "left" | "right" | "bottom" | "top"}>(({ className, side, sideOffset = 4, ...props }, ref) => (<TooltipPrimitive.Content
  side={side}
  ref={ref}
